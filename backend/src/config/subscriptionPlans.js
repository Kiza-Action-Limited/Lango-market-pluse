...
const FEATURE_KEYS = Object.freeze({
  ...
  LOGISTICS_COMMAND_CENTER: 'logisticsCommandCenter',
...
const baseBusinessFeatures = {
  ...
  [FEATURE_KEYS.PRODUCT_REVIEWS]: true,
  [FEATURE_KEYS.ORDER_NOTIFICATIONS]: true,
  [FEATURE_KEYS.SELLER_WALLET]: true,
  [FEATURE_KEYS.WITHDRAWALS]: true,
  [FEATURE_KEYS.ESCROW_ORDERS]: true,
  [FEATURE_KEYS.GROSS_PROFIT_DASHBOARD]: true,
  [FEATURE_KEYS.VITALS_PDF]: true,
  [FEATURE_KEYS.RFQ_INBOX]: false,
  [FEATURE_KEYS.RELATED_PRODUCTS]: false,
  [FEATURE_KEYS.LOGISTICS_COMMAND_CENTER]: false,
  [FEATURE_KEYS.INVENTORY_ALERTS]: false,
...
const PLANS = Object.freeze({
  ...
  [PLAN_IDS.SMART]: {
    ...
    features: {
      ...
      [FEATURE_KEYS.RFQ_INBOX]: true,
      [FEATURE_KEYS.RELATED_PRODUCTS]: true,
      [FEATURE_KEYS.LOGISTICS_COMMAND_CENTER]: true,
      [FEATURE_KEYS.INVENTORY_ALERTS]: true,
