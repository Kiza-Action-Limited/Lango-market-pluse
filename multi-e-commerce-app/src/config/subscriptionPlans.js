...
export const SUBSCRIPTION_FEATURES = {
  ...
  PRODUCTS_5000: 'products_5000',
  PRODUCTS_10000: 'products_10000',
  ...
  LOGISTICS_COMMAND_CENTER: 'logistics_command_center',
  INVENTORY_ALERTS: 'inventory_alerts',
  ACTIVE_SMS_CAMPAIGNS: 'active_sms_campaigns',
  SMS_CREDITS_20: 'sms_credits_20',
...
export const TRADER_PLANS = [
  {
    ...
    featureKeys: [
      ...
      F.CRM_CAPTURE,
      F.PRODUCT_REVIEWS,
      F.ORDER_NOTIFICATIONS,
      F.SELLER_WALLET,
      F.WITHDRAWALS,
      F.ESCROW_ORDERS,
      F.SMS_CREDITS_20,
    ],
    limits: { inventoryLimit: 200, smsCredits: 20 },
  },
  {
    id: PLAN_IDS.SMART,
    track: SUBSCRIPTION_TRACKS.TRADER,
    ...
    limits: { inventoryLimit: 5000, smsCredits: 500 },
  },
  {
    id: PLAN_IDS.GROWTH,
    track: SUBSCRIPTION_TRACKS.TRADER,
    ...
    limits: { inventoryLimit: 10000, smsCredits: 2000 },
  },
];
...
export const FEATURE_LABELS = {
  [F.PRODUCTS_200]: '200 product catalog allowance',
  [F.PRODUCTS_5000]: '5,000 product catalog allowance',
  [F.PRODUCTS_10000]: '10,000 product catalog allowance',
  [F.INVENTORY_LEDGER]: 'Inventory ledger and stock movement history',
  [F.QR_AUTO_SYNC]: 'Auto QR sync for sales and stock movement',
  [F.CRM_CAPTURE]: 'Passive CRM capture',
  [F.PRODUCT_REVIEWS]: 'Product reviews and ratings',
  [F.ORDER_NOTIFICATIONS]: 'Order notifications',
  [F.SELLER_WALLET]: 'Seller wallet balance',
  [F.WITHDRAWALS]: 'Withdrawal requests',
  [F.ESCROW_ORDERS]: 'Escrow-backed order transactions',
  [F.RFQ_INBOX]: 'RFQ inbox',
  [F.RELATED_PRODUCTS]: 'Related product recommendations',
  [F.LOGISTICS_COMMAND_CENTER]: 'Logistics command center',
  [F.INVENTORY_ALERTS]: 'Sensitive stock alerts',
  [F.ACTIVE_SMS_CAMPAIGNS]: 'Active CRM and outbound SMS campaigns',
  [F.SMS_CREDITS_20]: '20 SMS credits per cycle',
...
export const FEATURE_TOOLTIPS = {
  [F.PRODUCTS_200]: 'Solo allows up to 200 products.',
  [F.PRODUCTS_5000]: 'Smart allows up to 5,000 products.',
  [F.PRODUCTS_10000]: 'Growth allows up to 10,000 products.',
  [F.INVENTORY_LEDGER]: 'Track stock, thresholds, and movement history from seller product tools.',
  [F.SMS_CREDITS_20]: 'Solo includes 20 SMS credits each cycle.',
...
export const getUpgradePlanForFeature = (featureKey) => {
  const featureToPlan = {
    ...
    [F.RFQ_INBOX]: PLAN_IDS.SMART,
    [F.RELATED_PRODUCTS]: PLAN_IDS.SMART,
    [F.LOGISTICS_COMMAND_CENTER]: PLAN_IDS.SMART,
    [F.INVENTORY_ALERTS]: PLAN_IDS.SMART,
